...
//       <div
//         className="relative z-10 w-[90%] max-w-md rounded-2xl p-6 bg-gradient-to-r from-[#0b0f14] via-[#0b0f14] to-[#0a0e14] border border-white/10 shadow-[0_0_25px_rgba(59,130,246,0.9)]"
//       >
//         {/* Header */}
...
// ///////////////////////////////// ya se start ha trere code jo mane kiya tha ////////
...
// /////////////////////////////////////////////////////////// ya sanajna tere code ///  ya pr end ho raha
...
function Signup({ onToggle }) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center opacity-75 text-white relative">
      ...
      <div className="relative z-10 w-[90%] max-w-md rounded-2xl p-6 bg-gradient-to-r from-[#0b0f14] via-[#0b0f14] to-[#0a0e14] border border-white/10 shadow-[0_0_25px_rgba(59,130,246,0.9)]">
        {/* Header */}
        <div className="flex justify-between items-center mb-6">
          <div className="flex space-x-2 bg-[#2a2a2a] rounded-full p-1">
            <button
