...
return (
<> <div className="min-h-screen flex items-center justify-center opacity-75 text-white relative"> <div className="relative shadow-[0_0_25px_rgba(59,130,246,0.9)] border border-white/10 bg-gradient-to-r from-[#0b0f14] via-[#0b0f14] to-[#0a0e14] w-[90%] max-w-md rounded-2xl p-6">

```
      <div className="flex justify-between items-center mb-6">
        <div className="flex space-x-2 bg-[#2a2a2a] rounded-full p-1">
          <button onClick={onToggle} className="px-4 py-1 text-sm font-semibold text-white">
            Sign up
          </button>
      ...
      <div className="bg-[#1E1E1E] p-8 rounded-2xl w-[90%] max-w-md shadow-[0_0_25px_rgba(59,130,246,0.9)]">
        ...
        <form onSubmit={handleForgotPassword}>
          <input
            ...
            className="w-full bg-[#2a2a2a] p-3 rounded-md mb-4"
          />
          ...
          <div className="flex gap-4">
            <button
              ...
              className="w-full bg-[#2a2a2a] py-3 rounded-md"
            >
              Cancel
            </button>
