        ...
        <div className="lg:flex lg:items-center lg:justify-between">
          ...
          <div className="hidden lg:block">
            <img
              ...
              className="w-92 drop-shadow-2xl  animate-pulse transform transition-transform duration-300 hover:scale-105 hover:drop-shadow-[0_10px_25px_rgba(59,130,246,0.7)]"
            />
          </div>
        </div>
